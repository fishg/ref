...
#define SET_SIZEOF(name, type) \
  ...
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int8, int8_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint8, uint8_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int16, int16_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint16, uint16_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int32, int32_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint32, uint32_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int64, int64_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint64, uint64_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),float, float);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),double, double);
  // (potentially) variable sizes
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),bool, bool);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),byte, unsigned char);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),char, char);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uchar, unsigned char);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),short, short);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),ushort, unsigned short);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int, int);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint, unsigned int);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),long, long);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),ulong, unsigned long);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),longlong, long long);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),ulonglong, unsigned long long);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),pointer, char *);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),size_t, size_t);
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),wchar_t, wchar_t);
  // size of a Persistent handle to a JS object
  SET_SIZEOF(v8::Isolate::GetCurrent()->GetCurrentContext(),Object, Nan::Persistent<Object>);
...
#define SET_ALIGNOF(name, type) \
  ...
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int8, int8_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint8, uint8_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int16, int16_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint16, uint16_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int32, int32_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint32, uint32_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int64, int64_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint64, uint64_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),float, float);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),double, double);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),bool, bool);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),char, char);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uchar, unsigned char);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),short, short);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),ushort, unsigned short);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),int, int);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),uint, unsigned int);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),long, long);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),ulong, unsigned long);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),longlong, long long);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),ulonglong, unsigned long long);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),pointer, char *);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),size_t, size_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),wchar_t, wchar_t);
  SET_ALIGNOF(v8::Isolate::GetCurrent()->GetCurrentContext(),Object, Nan::Persistent<Object>);
